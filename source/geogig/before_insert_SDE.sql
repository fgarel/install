...
WHERE gestionnaire = 'Syndicat des Eaux de la Charente Maritime';
...
ALTER TABLE "EmprisePublicationPCRS"
  ALTER COLUMN gestionnaire SET DEFAULT 'Syndicat des Eaux de la Charente Maritime';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN source SET DEFAULT 'Système Information Geographique Syndicat des Eaux de la Charente Maritime';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "idSource" SET DEFAULT '';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_AFFLEURANT_SDE_AFFLEURANTSYMBOLE';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "reference" SET DEFAULT 'Symbole_SDE_X';
...
ALTER TABLE "ArbreAlignementPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_SDE_ARBREALIGNEMENT';
...
ALTER TABLE "BordurePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VOIRIE_SDE_BORDURE';
...
ALTER TABLE "ObjetGeneriquePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_SDE_OBJETGENERIQUE';
...
ALTER TABLE "FacadePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_BATI_SDE_FACADE';
...
ALTER TABLE "HaieEspaceVertPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_SDE_HAIEESPACEVERT';
...
ALTER TABLE "MurPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_CLOTURE_SDE_MUR';
...
ALTER TABLE "PointCanevasPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_SDE_POINTCANEVAS';
