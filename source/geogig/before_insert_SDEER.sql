...
WHERE gestionnaire = 'Syndicat Départemental d Electrification et d Equipement Rural';
...
ALTER TABLE "EmprisePublicationPCRS"
  ALTER COLUMN gestionnaire SET DEFAULT 'Syndicat Départemental d Electrification et d Equipement Rural';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN source SET DEFAULT 'Système Information Geographique Syndicat Départemental d Electrification et d Equipement Rural';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "idSource" SET DEFAULT '';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_AFFLEURANT_SDEER_AFFLEURANTSYMBOLE';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "reference" SET DEFAULT 'Symbole_SDEER_X';
...
ALTER TABLE "ArbreAlignementPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_SDEER_ARBREALIGNEMENT';
...
ALTER TABLE "BordurePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VOIRIE_SDEER_BORDURE';
...
ALTER TABLE "ObjetGeneriquePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_SDEER_OBJETGENERIQUE';
...
ALTER TABLE "FacadePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_BATI_SDEER_FACADE';
...
ALTER TABLE "HaieEspaceVertPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_SDEER_HAIEESPACEVERT';
