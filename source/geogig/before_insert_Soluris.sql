...
WHERE gestionnaire = 'Soluris Solutions Numériques Territoriales Innovantes';
...
INSERT INTO
  ...
  VALUES (
    'Soluris Solutions Numériques Territoriales Innovantes');
...
ALTER TABLE "EmprisePublicationPCRS"
  ALTER COLUMN gestionnaire SET DEFAULT 'Soluris Solutions Numériques Territoriales Innovantes';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN source SET DEFAULT 'Système Information Geographique Soluris Solutions Numériques Territoriales Innovantes';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "idSource" SET DEFAULT '';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_AFFLEURANT_SOLURIS_AFFLEURANTSYMBOLE';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "reference" SET DEFAULT 'Symbole_SOLURIS_X';
...
ALTER TABLE "ArbreAlignementPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_SOLURIS_ARBREALIGNEMENT';
...
ALTER TABLE "BordurePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VOIRIE_SOLURIS_BORDURE';
...
ALTER TABLE "ObjetGeneriquePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_SOLURIS_OBJETGENERIQUE';
...
ALTER TABLE "FacadePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_BATI_SOLURIS_FACADE';
...
ALTER TABLE "HaieEspaceVertPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_SOLURIS_HAIEESPACEVERT';
