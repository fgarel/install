...
WHERE gestionnaire = 'Électricité Réseau Distribution France';
...
ALTER TABLE "EmprisePublicationPCRS"
  ALTER COLUMN gestionnaire SET DEFAULT 'Électricité Réseau Distribution France';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN source SET DEFAULT 'Système Information Geographique Électricité Réseau Distribution France';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "idSource" SET DEFAULT '';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_AFFLEURANT_ERDF_AFFLEURANTSYMBOLE';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "reference" SET DEFAULT 'Symbole_ERDF_X';
...
ALTER TABLE "ArbreAlignementPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_ERDF_ARBREALIGNEMENT';
...
ALTER TABLE "BordurePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VOIRIE_ERDF_BORDURE';
...
ALTER TABLE "ObjetGeneriquePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_ERDF_OBJETGENERIQUE';
...
ALTER TABLE "FacadePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_BATI_ERDF_FACADE';
...
ALTER TABLE "HaieEspaceVertPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_ERDF_HAIEESPACEVERT';
...
ALTER TABLE "MurPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_CLOTURE_ERDF_MUR';
...
ALTER TABLE "PointCanevasPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_ERDF_POINTCANEVAS';
