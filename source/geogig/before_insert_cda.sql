...
WHERE gestionnaire = 'Communauté Agglomération La Rochelle';
...
ALTER TABLE "EmprisePublicationPCRS"
  ALTER COLUMN gestionnaire SET DEFAULT 'Communauté Agglomération La Rochelle';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN source SET DEFAULT 'Système Information Geographique Communauté Agglomération La Rochelle';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "idSource" SET DEFAULT '';

ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_AFFLEURANT_CDA_AFFLEURANTSYMBOLE';
...
ALTER TABLE "AffleurantSymbolePCRS"
  ALTER COLUMN "reference" SET DEFAULT 'Symbole_CDA_X';
...
ALTER TABLE "ArbreAlignementPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_CDA_ARBREALIGNEMENT';
...
ALTER TABLE "BordurePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VOIRIE_CDA_BORDURE';
...
ALTER TABLE "ObjetGeneriquePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_CDA_OBJETGENERIQUE';
...
ALTER TABLE "FacadePCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_BATI_CDA_FACADE';
...
ALTER TABLE "HaieEspaceVertPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_VEGETAL_CDA_HAIEESPACEVERT';
...
ALTER TABLE "MurPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_CLOTURE_CDA_MUR';
...
ALTER TABLE "PointCanevasPCRS"
  ALTER COLUMN "calque" SET DEFAULT 'PCRS_TOPOGRAPHIE_CDA_POINTCANEVAS';
