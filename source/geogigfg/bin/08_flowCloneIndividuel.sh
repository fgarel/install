#!/bin/sh
        ...
        echo "#"
        echo "# -----------------------------------------------------------------------------------"
        echo "# Clonage du depot local $DBREPO_LOCAL"
        echo "# vers un depot individuel $DBREPO_INDIVIDUEL"
        ...
        then
          ...
          echo "#"
          echo "geogig clone \"$REPO_LOCAL_ONE\" \ "
          echo "             \"$REPO_INDIVIDUEL_ONE\""
                geogig clone $REPO_LOCAL_ONE \
                             $REPO_INDIVIDUEL_ONE
        fi
