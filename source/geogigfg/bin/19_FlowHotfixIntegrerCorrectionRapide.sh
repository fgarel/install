#!/bin/sh
        ...
        echo "#"
        echo "# On merge la branche $BRANCHE_HOTFIX_1 dans la branche $BRANCHE_MASTER"
        echo "#"
        echo "# http://geogig.org/docs/repo/merging.html"
        echo "#"
        echo "geogig --repo \"$REPO_INDIVIDUEL_ONE\" \ "
        echo "       merge $BRANCHE_HOTFIX_1"
              geogig --repo $REPO_INDIVIDUEL_ONE \
                     merge $BRANCHE_HOTFIX_1
        echo "#"
        ...
        echo "#"
        echo "# On merge la branche $BRANCHE_HOTFIX_1 dans la branche $BRANCHE_DEVELOP"
        echo "#"
        echo "# http://geogig.org/docs/repo/merging.html"
        echo "#"
        echo "geogig --repo \"$REPO_INDIVIDUEL_ONE\" \ "
        echo "       merge $BRANCHE_HOTFIX_1"
              geogig --repo $REPO_INDIVIDUEL_ONE \
                     merge $BRANCHE_HOTFIX_1
        echo "#"
        echo "# On supprime la branche $BRANCHE_HOTFIX_1"
        echo "#"
        echo "# http://geogig.org/docs/repo/merging.html"
        echo "#"
        echo "geogig --repo \"$REPO_INDIVIDUEL_ONE\" \ "
        echo "       branch -d $BRANCHE_HOTFIX_1"
              geogig --repo $REPO_INDIVIDUEL_ONE \
                     branch -d $BRANCHE_HOTFIX_1
