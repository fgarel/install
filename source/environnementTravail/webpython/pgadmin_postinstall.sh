...
sed -i "s|DEFAULT_SERVER='localhost'|DEFAULT_SERVER='pgadmin.cdalr.fr'|g" /home/fred/.local/share/virtualenvs/pgadmin/lib/python3.5/site-packages/pgadmin4/config.py
sed -i "s|DEFAULT_SERVER = 'localhost'|DEFAULT_SERVER = 'pgadmin.cdalr.fr'|g" /home/fred/.local/share/virtualenvs/pgadmin/lib/python3.5/site-packages/pgadmin4/config.py
echo ""
echo ""
