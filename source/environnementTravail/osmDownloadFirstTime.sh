...
echo "#"
echo "# Dans notre cas, si notre téléchargement date du 1 mai 2017,"
...
echo "#"
echo "# 500.state.txt   :-> car il date du 30 avril 2017"
echo "#"
...
echo "sudo -u www-data wget http://download.geofabrik.de/europe/france/poitou-charentes-updates/000/001/500.state.txt"
      sudo -u www-data wget http://download.geofabrik.de/europe/france/poitou-charentes-updates/000/001/500.state.txt
echo "#"
echo "# Lorsqu'on a téléchargé le fichier xxx.state.txt, il est nécessaire de le renommer en state.txt"
echo "#"
echo "sudo -u www-data mv 500-state.txt state.txt"
      sudo -u www-data mv 500.state.txt state.txt
