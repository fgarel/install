...
echo '     --username=$datauser \'
echo '     --no-password \'
echo '     -f ~fred/Documents/install/source/environnementTravail/sql/analyse_base_osm_schema_apidb.sql'
#echo '     -f analyse_base_osm.sql'
      psql \
           ...
           --username=$datauser \
           --no-password \
           -f ~fred/Documents/install/source/environnementTravail/sql/analyse_base_osm_schema_apidb.sql
echo "#"
...
echo '     --username=$datauser \'
echo '     --no-password \'
echo '     -f ~fred/Documents/install/source/environnementTravail/sql/analyse_base_osm_schema_osm2pgsql.sql'
#echo '     -f analyse_base_osm.sql'
      psql \
           --host=$datahost \
           --dbname=$database \
           --username=$datauser \
           --no-password \
           -f ~fred/Documents/install/source/environnementTravail/sql/analyse_base_osm_schema_osm2pgsql.sql
echo "#"
