...
#      cd ..
echo "#"
echo "# On installe au préalable postgresql-11-python-multicorn"
echo "sudo apt-get install postgresql-11-python-multicorn"
      sudo apt-get install postgresql-11-python-multicorn
echo "#"
echo "#"
...
#echo "#   --------------------"
echo "#"
echo "# UPDATE : pg_cron ne semble pas fonctionner"
echo "# On utilisera directement le cron du système"
echo "#"
