...
echo "# il faut ajouter un depot stretch"
...
echo "#"
echo "sudo aptitude install -t stretch clang"
      sudo aptitude install -t stretch clang
...
echo "#"
echo "sudo rm -rf icu4c-59_1-src"
      sudo rm -rf icu4c-59_1-src
echo "# "
echo "tar -xzf icu4c-59_1-src.tgz"
...
echo "cd ../.."
      cd ../..
echo "#"
echo "rm icu4c-59_1-src.tgz"
      rm icu4c-59_1-src.tgz
echo "#"
echo "sudo ldconfig"
      sudo ldconfig
echo "#"
...
echo "#"
echo "sudo ./bjam --with-regex toolset=clang -sHAVE_ICU=1 -sICU_PATH=/usr/local/ -a install"
      sudo ./bjam --with-regex toolset=clang -sHAVE_ICU=1 -sICU_PATH=/usr/local/ -a install
echo ""
echo "#"
