...
echo "# --------------------"
echo '#'
echo "./webpython/webdjangoqgis_postinstall.sh"
echo "#"
echo "# --------------------"
echo '#'
echo "# --------------------"
echo '# Apres, avoir installé un serveur web, nginx'
echo '# Apres, avoir installé un environnemnent virtuel webdjangoqgis'
...
echo "#"
echo 'pew new -p $(pythonz locate 3.5.0) webdjangoqgis'
      pew new -p $(pythonz locate 3.5.0) webdjangoqgis
echo "#"
echo ""
