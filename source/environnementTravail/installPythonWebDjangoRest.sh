...
echo "# --------------------"
echo '#'
echo "./webpython/webdjangorest_postinstall.sh"
echo "#"
echo "# --------------------"
echo '#'
echo "# --------------------"
echo '# Apres, avoir installé un serveur web, nginx'
echo '# apres, avoir installé un environnemnent virtuel webdjangorest'
...
echo "#"
echo 'pew new -p $(pythonz locate 3.5.0) webdjangorest'
      pew new -p $(pythonz locate 3.5.0) webdjangorest
echo "#"
echo ""
