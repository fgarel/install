...
echo "tar xvf Python-$VERSION_PYTHON_LONG.tgz"
      tar xvf Python-$VERSION_PYTHON_LONG.tgz
echo "cd Python-$VERSION_PYTHON_LONG"
      cd Python-$VERSION_PYTHON_LONG
...
echo "cd .."
      cd ..
echo "sudo rm -rf Python-$VERSION_PYTHON_LONG"
      sudo rm -rf Python-$VERSION_PYTHON_LONG
...
echo "# est solutionné à la fin du fichier zshrc_antigen"
