...
echo "# Cependant, au lancment du service via la commande tirex-master"
echo "# nous avons eu ce type d'erreur :"
...
echo "sudo aptitude -y install devscripts"
      sudo aptitude -y install devscripts
echo "sudo apt-get -y install devscripts"
      sudo apt-get -y install devscripts
echo "sudo aptitude -y install fakeroot"
      sudo aptitude -y install fakeroot
echo "sudo apt-get -y install fakeroot"
      sudo apt-get -y install fakeroot
echo "sudo aptitude -y install debhelper"
      sudo aptitude -y install debhelper
echo "sudo apt-get -y install debhelper"
...
echo "#"
echo "#"
echo "sudo apt-get -y install libmapscript-perl"
      sudo apt-get -y install libmapscript-perl
echo "sudo apt-get -y install libgd-perl"
      sudo apt-get -y install libgd-perl
echo "sudo apt-get -y install libwww-perl"
