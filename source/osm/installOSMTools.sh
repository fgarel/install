...
echo "# L'outil carto, nécessaire pour manipuler les feuilles de style est installé via npm"
...
echo "# Cette partie est aussi installée manuellement"
echo "#"
echo "# La liste des composants d'OSM est ici"
echo "# http://wiki.openstreetmap.org/wiki/FR:Component_overview"
echo "#"
echo "# carto est l'outil pour manipuler les feuilles de styles"
...
echo "#"
echo "#"
echo "# Installation de carto à l'aide de npm :"
echo "# CartoCSS permet de manipuler des feuilles de styles"
echo "# https://github.com/mapbox/carto"
echo "sudo npm install -g carto"
      sudo npm install -g carto
echo "sudo npm install -g millstone"
