...
echo "# osmDownloadOtherTimeWww-data.sh"
echo "###############################################"
#echo "#"
...
echo "export OLDPWDFG=$(pwd)"
      ...
      echo $OLDPWDFG
echo "#"
echo "cd ~fred/Documents/osmosis"
      cd ~fred/Documents/osmosis
echo "#"
...
echo "cat ~fred/Documents/osmosis/state.txt"
      cat ~fred/Documents/osmosis/state.txt
echo "#"
echo "#"
